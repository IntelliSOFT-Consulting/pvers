 ...
 ?>
	...
	<div class="row-fluid">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="#"><?php 	echo $help_infos['sadr_edit_tab1']['content'].' '.$this->data['Sadr']['id']; ?></a></li>
			<li><?php 	echo $this->Html->link($help_infos['sadr_edit_tab2']['content'].'('.$followups.')', array('controller' => 'sadr_followups', 'action' => 'sadrIndex', $this->data['Sadr']['id'])); ?></li>
		</ul>
			...
			<div class="form-actions">
				<div class="row-fluid">
					<div class="span6">
						<?php
							echo $this->Form->button('Save  Report', array(
									'name' => 'submitReport',
