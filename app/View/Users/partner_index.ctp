				...
				<div class="pagination">
					...
					?>
						<tr>
							...
							<td>
								<?php //echo $this->Form->postLink(__('<span class="label label-info tooltipper" title="Confirm">Confirm </span>'), 
										//array('action' => 'confirm', $user['User']['id']), array('escape' => false), __('Are you sure you want to Confirm the User %s?', $user['User']['username'])); ?>&nbsp;
							</td>
						</tr>
					<?php endforeach; ?>		
					</tbody>
