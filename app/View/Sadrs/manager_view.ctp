        ...
        if (!empty($sadr['Sadr']['assigned_to'])) { ?>
          ...
          <div class="row-fluid">
            <div class="span4 center">
              ...
              <span><?php 
              echo $this->Html->link('Unassign Report', array('controller'=>'sadrs','action'=>'unassign', $sadr['Sadr']['id']),
														array('class' => 'btn btn-primary mapop', 'title'=>'Unassign Report',
														'data-content' => 'Download the pdf version of the report',))?></span>
            </div>
            <?php
          } else {
            ?>
