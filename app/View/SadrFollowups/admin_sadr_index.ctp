	...
	<div class="span12">	
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php echo $this->Html->link('View', array('controller' => 'sadr_followups', 'action' => 'view',$SadrFollowup['SadrFollowup']['id'] )); ?>&nbsp;|&nbsp;
					<?php echo $this->Html->link('Edit', array('controller'=>'sadr_followups', 'action'=>'edit', $SadrFollowup['SadrFollowup']['id'])) ?>
					</td>
			</tr>
			<?php endforeach; ?>		
		</tbody>
		...
		<?php echo $this->Html->link('Back to initial SADR', array('controller'=>'sadrs', 'action'=>'edit', $this->request->params['pass'][0])) ?>
		<?php } ?>
	</div>
</div>
</section>
