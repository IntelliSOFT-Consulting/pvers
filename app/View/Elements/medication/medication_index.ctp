        ...
        <td class="actions">
            <?php 
              if($medication['Medication']['submitted'] > 1) {
                ...
                if($redir != 'manager' && $medication['Medication']['copied'] != 2) echo $this->Html->link('<span class="label label-success tooltipper" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </span>' ,
                  array('controller' => 'medications', 'action' => 'edit', $medication['Medication']['id']),
                  array('escape' => false));
              }
            ?>            
