<?php
	...
	$config['Queue']['workermaxruntime'] = 0; //Warning: Do not use 0 if you are using a cronjob to permanantly start a new worker once in a while and if you do not exit on idle.
