...
<table style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; width: 780px; border: 10px solid #488E48;" border="0" cellspacing="0" cellpadding="10" align="center" bgcolor="#FFFFFF">
  <tbody>
    ...
    <tr>
      <td><p><strong><a name="1"></a>Suspected Adverse Drug Report</strong></p>
        ...
        <p>The UNIQUE Identification Number of the Report is <strong><?php echo $aefi['Aefi']['id']; ?></strong></p>
		<p>You may use the unique Identification Number to create a follow up report.</p>
		<p>To edit the report, click on the following link.</p>
		<p><a href="<?php echo $root;?>aefis/edit/<?php echo $aefi['Aefi']['id'];?>" target="_blank" > <?php echo $root;?>aefis/edit/<?php echo $aefi['Aefi']['id'];?> </a></p><br/>
