				...
				<div class="span12"> 	
					...
					<div class="contentpadded">
						...
						<div class="row-fluid">
							<div class="span12">
								<?php
									echo $this->Form->input('aefi_id', array('type' => 'hidden', 'value' => $aefi['Aefi']['id']));
									echo $this->Form->input('receiver', array('type' => 'hidden', 'value' => $aefi['Aefi']['reporter_email']));
								?>
								<p>To: <strong><?php
									echo $aefi['Aefi']['reporter_email'];
								?></strong></p>
							</div>
						</div>
						 <hr>						
							...
							<div class="span12">
								<?php								
									...
									echo $this->Form->input('message', 
										array('rows'=>'20', 'value' => $this->element('emails/reply_aefi'),
