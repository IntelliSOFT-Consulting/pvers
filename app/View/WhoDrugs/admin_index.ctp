							...
							<tr>
								...
								<td>
									<?php echo $this->Html->link('<span class="label label-info"><i class="icon-pencil icon-white"></i> Edit</span>' , 
											array('controller' => 'who_drugs', 'action' => 'edit', $whoDrug['WhoDrug']['id']), array('escape' => false)); ?>&nbsp;
									<?php echo $this->Form->postLink(__('<span class="label label-important"><i class="icon-trash icon-white"></i> Delete</span>'), 
											array('action' => 'delete', $whoDrug['WhoDrug']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $whoDrug['WhoDrug']['id'])); ?>&nbsp;
								</td>
							</tr>
						<?php endforeach; ?>		
						</tbody>
