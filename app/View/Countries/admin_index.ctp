	...
	<div class="row-fluid" style="margin-bottom: 9px;">	
		...
		<div class="span10 columns">
				...
				<div class="row-fluid">
					...
					<?php
						echo $this->Form->input('name', array('div' => false, 'class' => 'span10', 'label' => array('class' => 'required', 'text' => 'Country Name')));
					?>
					</div>
							...
							<tr>
								...
								<td>
									<?php echo $this->Html->link('<span class="label label-info"><i class="icon-pencil icon-white"></i> Edit</span>' , 
											array('controller' => 'countries', 'action' => 'edit', $country['Country']['id']), array('escape' => false)); ?>&nbsp;
									<?php echo $this->Form->postLink(__('<span class="label label-important"><i class="icon-trash icon-white"></i> Delete</span>'), 
											array('action' => 'delete', $country['Country']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $country['Country']['id'])); ?>&nbsp;
								</td>
							</tr>
						<?php endforeach; ?>		
						</tbody>
