...
<table style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; width: 780px; border: 10px solid #488E48;" border="0" cellspacing="0" cellpadding="10" align="center" bgcolor="#FFFFFF">
  <tbody>
    ...
    <tr>
      <td><p><strong><a name="1"></a>New Suspected Adverse Drug Follow UP Report </strong></p>
        <p>You are getting this email because you have selected to report a follow up to a Suspected Adverse Reaction Report.</p> <br>
		...
		<p><a href="<?php echo $root;?>sadr_followups/edit/<?php echo $ID;?>" target="_blank" > <?php echo $root;?>sadr_followups/edit/<?php echo $ID;?> </a></p>
		<p><strong>Note</strong> that you can only edit a report that you have not submitted yet. Once you submit it, the report resides at the Pharmacy and Poisons Board and only they
