...
<div class="row-fluid">
  ...
  <div class="row-fluid">
    <div class="span12">
    <?php
      echo $this->Html->link('<i class="icon-file"></i> New MEDICATION',
    ...
    <tr class="">
        ...
        <td>
          <?php 
            // echo h($medication['Medication']['reference_no']); 
        ...
        <td class="actions">
            <?php if($medication['Medication']['submitted'] > 1) echo $this->Html->link(__('<label class="label label-info">View</label>'), array('action' => 'view', $medication['Medication']['id']), array('escape' => false)); ?>
            <?php if($redir === 'applicant' && $medication['Medication']['submitted'] < 1) echo $this->Html->link(__('<label class="label label-success">Edit</label>'), array('action' => 'edit', $medication['Medication']['id']), array('escape' => false)); ?>
            <?php
              if($medication['Medication']['submitted'] < 1 && $redir === 'applicant') {
                echo $this->Form->postLink(__('<label class="label label-important">Delete</label>'), array('action' => 'delete', $medication['Medication']['id'], 1), array('escape' => false), __('Are you sure you want to delete # %s?', $medication['Medication']['id']));
              } 
            ?>            
        </td>
    </tr>
