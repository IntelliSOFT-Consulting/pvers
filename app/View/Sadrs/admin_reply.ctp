						...
						<div class="row-fluid">
							<div class="span12">
								<?php
									...
									echo $this->Form->input('receiver', array('type' => 'hidden', 'value' => $sadr['Sadr']['reporter_email']));
								?>
								<p>To: <strong><?php
									echo $sadr['Sadr']['reporter_email'];
								?></strong></p>
							</div>
						</div>
						 <hr>						
							...
							<div class="span12">
								<?php								
									...
									echo $this->Form->input('message', 
										array('rows'=>'20', 'value' => $this->element('emails/reply_sadr'),
