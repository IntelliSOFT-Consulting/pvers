...
<?php echo $this->Form->create('SadrListOfMedicine'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sadr List Of Medicine'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SadrListOfMedicine.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('SadrListOfMedicine.id')))); ?></li>
