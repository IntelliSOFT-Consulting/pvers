						...
						<ul class="nav nav-list">
						  ...
						  <li class="active">
							<?php echo $this->Html->link('<i class="icon-backward"></i> Back', 
										array('controller' => 'sadrFollowups', 'action' => 'index', 'submitted'=>'1', 'admin' => true), 
										array('escape' => false)); ?>
						  </li>
						  <li class="divider"></li>
				...
				<div class="span12"> 	
					...
					<div class="contentpadded">
						...
						<div class="row-fluid">
							<div class="span12">
								<?php
									echo $this->Form->input('sadr_followup_id', array('type' => 'hidden', 'value' => $sadrsFollowup['SadrFollowup']['id']));
									echo $this->Form->input('receiver', array('type' => 'hidden', 'value' => $sadrsFollowup['SadrFollowup']['reporter_email']));									
								?>
								<p>To: <strong><?php
									echo $sadrsFollowup['SadrFollowup']['reporter_email'];
								?></strong></p>
							</div>
						</div>
						 <hr>						
							...
							<div class="span12">
								<?php								
									...
									echo $this->Form->input('message', 
										array('rows'=>'20', 'value' => $this->element('emails/reply_sadrsFollowup'),
