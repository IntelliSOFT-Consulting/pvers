        ...
        <td class="actions">
            <?php 
              if($sadr['Sadr']['submitted'] > 1) {
                ...
                echo "&nbsp;";
                if($redir == 'manager' && empty($sadr['Sadr']['vigiflow_ref'])) echo $this->Html->link('<span class="label label-warning tooltipper" title="Send to vigiflow"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> Vigiflow </span>' ,
