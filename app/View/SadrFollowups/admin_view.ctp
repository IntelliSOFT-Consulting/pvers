		...
		<hr>		
		  <div class="tabbable" style="margin-bottom: 18px;">
			<ul class="nav nav-tabs">
			  <li>
				<?php 
					echo $this->Html->link('Initial Report ID: '.$sadrsFollowup['SadrFollowup']['sadr_id'], array('controller' => 'sadrs', 'action' => 'edit', $sadrsFollowup['SadrFollowup']['sadr_id'])); 
				?> 
			  </li>
			  ...
			  <div class="tab-pane active" id="tab1">
				...
				<div class="form-actions">
					<div class="row-fluid">
						<div class="span4">
							<?php							
								echo $this->Html->link('Download PDF', array('action'=>'download', 'ext'=> 'pdf', $sadrsFollowup['SadrFollowup']['id'], 'admin' => false), 
							...
							<table class="table table-bordered  table-condensed table-pvborder" id="buildattachmentsform">
								...
								<?php
									...
									<tr>
										<td><?php echo $i++;?></td>
										<td><?php  
											echo $this->Html->link(__($attachment['basename']), 
