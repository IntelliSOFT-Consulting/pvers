						...
						<div class="logincontainer">
							...
							<fieldset>
								<div class="clearfix">
									...
									<div class="input">
										<input type="text" id="UserUsername" maxlength="255" class="span10" name="data[User][username]">
									</div>
								</div>
								...
								<div class="clearfix">
									...
									<div class="input">
										<input type="password" id="UserPassword" class="span10" name="data[User][password]">
									</div>
								</div>
