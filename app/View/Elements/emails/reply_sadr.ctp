  ...
  <tbody>
    ...
    <tr>
      <td><p><strong><a name="1"></a>Suspected Adverse Drug Report</strong></p>
        ...
        <p>The UNIQUE Identification Number of the Report is <strong><?php echo $sadr['Sadr']['id']; ?></strong></p>
		...
		<p><a href="<?php echo $root;?>sadrs/edit/<?php echo $sadr['Sadr']['id'];?>" target="_blank" > <?php echo $root;?>sadrs/edit/<?php echo $sadr['Sadr']['id'];?> </a></p><br/>
