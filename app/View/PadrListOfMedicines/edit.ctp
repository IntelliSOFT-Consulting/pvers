...
<?php echo $this->Form->create('PadrListOfMedicine'); ?>
	<fieldset>
		<legend><?php echo __('Edit Padr List Of Medicine'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PadrListOfMedicine.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('PadrListOfMedicine.id')))); ?></li>
