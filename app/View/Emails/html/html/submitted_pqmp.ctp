...
<table style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; width: 780px; border: 10px solid #488E48;" border="0" cellspacing="0" cellpadding="10" align="center" bgcolor="#FFFFFF">
  <tbody>
    ...
    <tr>
      <td><p><strong><a name="1"></a>Submission of a Poor Quality Medicinal Product (PQMP) report</strong></p>
        <p>Your report has been received at the Pharmacy and Poisons Board and will be evaluated.</p>
		...
		<p><a href="<?php echo $root;?>pqmps/view/<?php echo $ID;?>" target="_blank" > <?php echo $root;?>pqmps/view/<?php echo $ID;?> </a></p>
		<p>To download a pdf copy of the report, click on the link below or copy and paste it into your browser.</p>
		<p><a href="<?php echo $root;?>pqmps/download/<?php echo $ID;?>.pdf" target="_blank" > <?php echo $root;?>pqmps/download/<?php echo $ID;?>.pdf </a></p>
	  </td>
    </tr>
  </tbody>
</table>
