...
?>
	<header class="jumbotron subhead" id="overview">
		<div id="subheader">
			<h2>Suspected Adverse Drug Report </h2>
			<!-- --><p class="lead">NO : <?php echo $this->data['Sadr']['id'] ?>			
			<div class="subnav">
			  <ul class="nav nav-pills">        
				<li class="active"><?echo $this->Html->link('Edit', array('controller' => 'sadrs', 'action' => 'edit', $this->data['Sadr']['id'])); ?></li>
			  <?php if($this->Session->read('Auth.User')) { ?>
				<li><?echo $this->Html->link('List My Reports', array('controller' => 'sadrs', 'action' => 'list')); ?></li>
			  <?php } ?>
			</div>
		</div>
	</header>
...
<div class="row-fluid">
	<div class="span12">
		...
		<div class="row-fluid">
			<div class="span12">
				<?php
					echo $this->Html->image('sadr_header.png', array('alt' => 'SADR'));
				?>
			</div>
		</div><br>
		<div class="row-fluid">
			<div class="span8">
			<p class="controls">	<span class="label label-important">Tip:</span> Fields marked with <span style="color:red;">*</span> are mandatory</p>
			<?php
				echo $this->Form->input('report_title', array(
					'label' => array('class' => 'control-label required', 'text' => $help_infos['report_title']['field_label']),
					'title'=>$help_infos['report_title']['title'], 'data-content' => $help_infos['report_title']['content'],
					'after'=>'<p class="help-block">	'.$help_infos['report_title']['help_text'].' </p></div>',
					'class' => 'span9 '.$help_infos['report_title']['help_type'].'',
				));
			 ?>
			</div>
			<div class="span4">
			...
			<div class="span6">
				<?php
					echo $this->Form->input('patient_name', array(
						'label' => array('class' => 'control-label required', 'text' =>  $help_infos['patient_name']['field_label']), 
				...
				<?php
					echo $this->Form->input('date_of_birth', array(
						'type' => 'text', 
						'label' => array('class' => 'control-label required', 'text' => $help_infos['date_of_birth']['field_label']),
						'title'=>$help_infos['date_of_birth']['title'], 'data-content' => $help_infos['date_of_birth']['content'],
						'after'=>'<p class="help-block">	'.$help_infos['date_of_birth']['help_text'].' </p></div>',
			...
			<div class="span12">
				<?php
					...
					echo $this->Form->input('description_of_reaction', array(
						'rows' => '2', 
						'label' => array('class' => 'control-label required', 'text' => $help_infos['description_of_reaction']['field_label']),
					...
					echo $this->Form->input('date_of_onset_of_reaction', array(
						'type' => 'text', 
						'label' => array('class' => 'control-label required', 'text' => $help_infos['date_of_onset_of_reaction']['field_label']),
						...
						'class' => $help_infos['date_of_onset_of_reaction']['help_type'].'',						
					));
		...
		<div class="row-fluid">
			<div class="span3">
				...
				<?php
					echo $this->Html->link('Click to view Severity scale below', '#collapseOne', 
			...
			<div class="span3">
				...
				<?php				
					echo $this->Html->link('Click to view causality Scale below', '#collapseTwo', 
												 array('class' => 'accordion-toggle', 'data-toggle'=>"collapse", 'data-parent'=>'#accordion1'));
			...
			<div class="span6">
				<?php
					echo $this->Form->input('reporter_name', array(	
						...
						'label' => array('class' => 'control-label required', 'text' => $help_infos['reporter_name']['field_label']),
					...
					echo $this->Form->input('reporter_email', array(
						'type' => 'email', 
						'div' => array('class' => 'control-group required'),
						'label' => array('class' => 'control-label required', 'text' => $help_infos['reporter_email']['field_label']),
			...
			<div class="span6">
				<?php
					...
					echo $this->Form->input('designation_id', 
							array('label' => array('class' => 'control-label required', 'text' => 'DESIGNATION'), 'empty'=>true ));
		...
		<div class="form-actions">
			<div class="row-fluid">
				...
				<div class="span4">
					<?php
						echo $this->Form->button('Review', array(
								'name' => 'submitReport',
								'class' => 'btn btn-success mapop',
								'id' => 'SadrSubmitReport', 'title'=>'Review report', 
								'data-content' => 'Review report contents before submitting.',
								'div' => false,
							));
